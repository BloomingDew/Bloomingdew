      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '3rem 2rem' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={card}>
            ...
            <label style={{
              display: 'block', border: '2px dashed #E8DDD3', padding: '2rem',
              textAlign: 'center', cursor: 'pointer', backgroundColor: '#FAFAFA', marginBottom: '1rem',
            }}>
              ...
              {uploadingImage ? (
                ...
                <>
                  <p style={{ fontFamily: "'Jost', sans-serif", fontSize: '0.88rem', color: '#2C2C2C', marginBottom: '0.3rem' }}>Click to upload images</p>
                  <p style={{ fontFamily: "'Jost', sans-serif", fontSize: '0.75rem', color: '#9A8F87' }}>JPG, PNG, WEBP — multiple files supported</p>
                </>
              )}
            </label>
